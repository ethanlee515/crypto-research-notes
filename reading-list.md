...
2. The "second generation" (2011-) consists of the "BGV" and "BFV" constructions.
	...
	* The "BFV" construction consists of the [Brakerski paper](https://eprint.iacr.org/2012/078) and the optimizations given by the follow-up [FV paper](https://eprint.iacr.org/2012/144). Brakerski gave an overview of his work here in a two-part blog post with Boaz Barak ([part1](https://windowsontheory.org/2012/05/01/the-swiss-army-knife-of-cryptography/), [part2](https://windowsontheory.org/2012/05/02/building-the-swiss-army-knife/)).
